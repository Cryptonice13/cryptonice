...
export const DepositModal = ({ open, onOpenChange, tokenSymbol }: DepositModalProps) => {
  const [amount, setAmount] = useState('');
  const { deposit, isTransactionPending } = useLendingPool();
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            >
              {isTransactionPending ? 'Depositing...' : 'Deposit'}
            </Button>
          </div>
        </div>
      </DialogContent>

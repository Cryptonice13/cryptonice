...
export const FeaturesSection = () => {
  return <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        ...
        <p className="text-lg md:text-xl text-gray-400 text-left">Experience industry-grade lending and staking tools and features designed for both novice and experienced crypto lending.</p>
      </div>
